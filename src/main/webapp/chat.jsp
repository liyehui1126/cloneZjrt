...
<div id="container" style="width:500px">
    ...
    <div id="content">
        <textarea class="form-control" rows="3" placeholder="我想说....." id="msgContent"></textarea>
    </div>

    <div style="background-color: #F8F8F8;">
        <div id="buttons">
            <button id="butSent" type="button" class="btn btn-default" onclick="getConnection()">连接</button>
            <button type="button" class="btn btn-default" onclick="sendMsgClose()">断开</button>
            <button type="button" class="btn btn-default" onclick="sendMsg()">发送</button>
            <button type="button" class="btn btn-default" onclick="clearMsg()">清屏</button>
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#imgModal">上传图片</button>
            <input type="text" name="receiveUserName" id="receiveUserName" value="" placeholder="输入想发送的人"><br/>
            <input type="file" name="userImage" id="userImage1" onchange="check()" placeholder="请选择要上传的图片">
            <button type="button" class="btn btn-default" onclick="sendImg()">发送图片</button>
